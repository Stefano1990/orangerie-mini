...
config :orangerie, OrangerieWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: OrangerieWeb.ErrorHTML, json: OrangerieWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Orangerie.PubSub,
  live_view: [signing_salt: "QA5excSL"]
...
config :orangerie, Orangerie.Mailer, adapter: Swoosh.Adapters.Local
